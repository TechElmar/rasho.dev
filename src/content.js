...
window.CONTENT = (function () {
  ...
  const profile = {
    ...
    intro: [
      'Hi, I&rsquo;m Elmar. Assyrian, born and raised in Hamilton, Ontario, and hooked on computers from the moment I got my hands on one.',
      ...
      'From a young age the dream was specific: <em>make something a lot of people actually use</em>. That&rsquo;s happened twice now, and neither time did I charge for it. PokeDropz runs free for 7,000+ people in Canada&rsquo;s biggest Pok&eacute;mon TCG Discord. My music has passed 2 million plays with no monetisation on it. I like building the thing and handing it over more than I like owning it.',
      'Away from a keyboard I&rsquo;m in the gym, on a snowboard, or making music. Those three aren&rsquo;t a break from the work. They&rsquo;re the same instinct pointed somewhere else.',
    ],
  ...
  const life = [
    {
      ...
      text: 'Assyrian, born and raised here. I got my hands on a computer early and that was more or less that. I knew before I could explain why that I wanted to build software.',
    },
    {
      year: 'early',
      title: 'The rush',
      text: 'I liked making things out of smaller pieces long before I had a word for it. Coding just gave it a name. Writing lines and lines, debugging, hunting the one syntax error, and the moment it finally works there&rsquo;s a rush like nothing else. I&rsquo;m still chasing that one.',
    },
    {
      year: '2021',
      title: 'Two things clicked at once',
      text: 'I got serious in the gym, and at the same time I found my way back to EDM and dubstep, music I&rsquo;d genuinely loved as a kid, then buried in high school listening to whatever everyone else decided was cool. Both stuck. Neither has let go since.',
    },
    {
      year: '2022',
      title: 'Western, and the shop floor',
      text: 'Started my CS degree at Western in London, and started at Popeye&rsquo;s Supplements in Hamilton. I&rsquo;m still at the second one four years later. Years of self-taught gym and supplement knowledge is exactly how I got that job, and how I&rsquo;ve been useful in it.',
    },
    {
      year: '2025',
  ...
  const passions = [
    {
      ...
      body: [
        'The gym is my solo time, the place I let off steam and nobody needs anything from me. It also scratches exactly the same itch coding does. You put in the work, sets and reps, and one day you look in the mirror and you&rsquo;re measurably different. Input, output, delayed but undeniable. Same feeling as watching a build finally go green.',
        'None of what I learned stayed with me. I give gym and lifestyle advice almost every day: to friends, to family, to customers. It&rsquo;s also the whole reason I got hired at Popeye&rsquo;s: I already knew supplements cold because I&rsquo;d taught myself, and I could turn that into a straight answer for someone standing in front of me.',
      ],
      points: [
    ...
    },
    {
      ...
      // A snippet of your own track: cover art plus play button. Keep it short.
      media: {
        kind: 'audio',
    ...
    },
    {
      ...
      body: [
        'It started as a single trip for a friend&rsquo;s birthday. Now every winter is built around it: getting out with my boys, ripping down hills, and coming back with one more trick than I left with.',
